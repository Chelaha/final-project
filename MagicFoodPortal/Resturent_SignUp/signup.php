        ...
        <div class="common-font">
            <table>
                <tr align="center" style="width: 40%;">
                  <th><h1 class="common-font">Register as Resturent Owner</h1></th>
                  <th></th>
                </tr>
                ...
                <tr align="center">
                    <td style="width: 40%;">
                        ...
                        <form class="form-control-lg align-content-md-center" align="left" style="width: 60%;" action="Resturent_signup_backend.php" method="POST">
                            ...
                            <input type="submit" class="btn btn-primary" onClick="save()" name="signup" value="Sign Up">&nbsp;
                            <button type="reset" class="btn btn-light">Cancel</button>

                        </form>

                        Already have an account? <a href="http://localhost/FoodOrder/Resturent_Login/login.php">Login</a>
                        
                    </td>

                    <td>
                        <img src="https://images.unsplash.com/photo-1588123190131-1c3fac394f4b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1965&q=80" />
                    </td>
                </tr>
              </table>
        </div>
